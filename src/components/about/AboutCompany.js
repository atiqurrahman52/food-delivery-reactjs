          ...
          <div class="container">
            <div class="py-10 lg:py-20">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="">
                  <p
                    class="font-Raleway font-semibold text-sm lg:text-base leading-[21px] lg:leading-6 text-primary/80 mb-4"
                  >
                    Feature one
                  </p>
                  <p
                    class="font-Playfair font-bold text-2xl lg:text-[32px] leading-[34px] lg:leading-[42px] text-primary mb-6"
                  >
                    About [company name]
                  </p>
                  <p
                    class="font-Raleway font-medium text-sm lg:text-base leading-[21px] lg:leading-6 text-primary/80 mb-4"
                  >
