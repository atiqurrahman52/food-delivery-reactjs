          ...
          <div class="container">
            <div class="py-10 lg:py-20">
              <div class="text-center">
                <div>
                  <div class="flex justify-center items-center mb-3 lg:mb-4">
                    <img class="" src={user} alt="" />
                    
                  </div>
                  <h3
                    class="font-Playfair font-medium text-base leading-6 text-primary mb-6"
                  >
                    Name Surname
                  </h3>
                  ...
                  <p
                    class="font-Playfair font-bold text-base lg:text-2xl leading-[22px] lg:leading-[34px] text-primary md:px-20 lg:px-32"
                  >
