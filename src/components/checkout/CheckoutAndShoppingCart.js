  ...
  return (
    <div>
      ...
      <div className="container">
        ...
        >
          <li className="current step0">
            <span className="icon">
            <Check size={24} />
            </span>
            <span className="block whitespace-nowrap">Shopping Cart</span>
          </li>
          <li className="step0">
            <span className="icon">
      ...
      <section id="shopping-cart" className="first-screen show hidde card2">
        <div className="container">
      ...
      <section id="checkout" className="hidde card2">
        <div className="container">
          <div className="grid grid-cols-12 gap-3 lg:gap-4">
            <div className="col-span-12 lg:col-span-8">
              ...
              <div>
                <button className="prev button flex items-center justify-center space-x-[6px] lg:space-x-2.5 border border-[#EBEBEB] rounded-xl w-[162px]  h-11 lg:h-14 mb-16">
                <CaretLeft size={18}  />
                  <p className="font-Raleway font-bold text-base leading-6 text-primary">
                    Shopping cart
                  </p>
            ...
            <div className="col-span-12 lg:col-span-4 p-4 max-h-[480px] border border-[#EBEBEB] rounded-lg mb-4">
              <p className="font-Playfair font-bold text-xl leading-[30px] text-primary border-b border-[#EBEBEB] pb-3 mb-4">
                Cart Total
              </p>
              <div className="flex justify-between mb-2">
        ...
        <div className="container">
          <div className="grid grid-cols-12 gap-3 lg:gap-4">
            <div className="col-span-12 lg:col-span-8">
              ...
              <div>
                <button className="prev button flex items-center justify-center space-x-[6px] lg:space-x-2.5 border border-[#EBEBEB] rounded-xl w-[146px] h-11 lg:h-12 mb-16">
                <CaretLeft size={18}  />
                  <p className="font-Raleway font-bold text-base leading-6 text-primary">
                    Checkout
                  </p>
            ...
            <div className="col-span-12 lg:col-span-4 p-4 max-h-[480px] border border-[#EBEBEB] rounded-lg mb-4">
              ...
              <button
                className="h-10 lg:h-[52px] w-full bg-[#248C80] shadow-[0_20px_24px_-4px_rgba(0,0,0,0.08),0_8px_8px_-4px_rgba(0,0,0,0.03)] rounded font-Raleway font-bold text-base leading-6 text-white"
                type=""
              >
                Proceed to $ 1,750
              </button>
