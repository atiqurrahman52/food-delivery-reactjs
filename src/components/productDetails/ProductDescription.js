          ...
          <div className="grid grid-cols-12 gap-6">
            ...
            <div className="col-span-12 lg:col-span-5">
              ...
              <div className="product-card">
                <button
                  type=""
                  className="font-Raleway font-medium text-sm lg:text-base leading-[21px] lg:leading-6 py-2 text-success md:py-3 w-full md:w-[308px] h-[48px] border border-success rounded-[5px] z-[1] relative overflow-hidden add-to-cart-btn"
                >
                  Add to cart
                </button>
              </div>
