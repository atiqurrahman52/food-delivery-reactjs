              ...
              <div className="pb-6">
                <div className="flex justify-between flex-col lg:flex-row mb-3">
                  <div className="flex items-center space-x-4 lg:space-x-5">
                    ...
                    <div>
                      ...
                      <p className="font-Raleway text-[13px] leading-6 text-[#456170]">
                        09 Mar 2020
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-2">
                    <div className="flex space-x-1">
                      ...
                      >
                        <path
                          d="M7.5 0.5L9.81813 5.43694L15 6.23082L11.2485 10.0731L12.1333 15.5L7.5 12.9385L2.86374 15.5L3.74853 10.0731L0 6.23082L5.18187 5.43694L7.5 0.5Z"
                          fill="#EEC32A"
                        />
                      </svg>
                      <svg
                    ...
                    <div>
                      <p className="font-Raleway font-bold text-sm leading-[21px] text-[#0E0E10]">
                        4 <span className="text-[#0E0E10] opacity-50">/5</span>
                      </p>
                    </div>
                  </div>
                </div>
                <p className="font-Raleway font-medium text-sm leading-[21px] text-[#012232] mb-3">
                  So when your site is looked for on the search engine it will
                  be very easy to come across as it will come up as one of the
                  first.
                </p>
                ...
                <div className="flex items-center space-x-4">
                  <div className="flex items-center space-x-2">
                    ...
                    <p className="font-Raleway font-bold text-xs leading-[18px] text-primary/60">
                      Like (9)
                    </p>
                  </div>
      ...
      <section id="form">
        <form>
          <div className="bg-[#F9F6F1]">
            <div className="container">
              <div className="max-w-[641px] py-8">
                <h3 className="font-Playfair font-bold text-xl lg:text-2xl leading-[28px] text-[#012232] mb-4">
                  Leave a Comment
                </h3>
                <p className="font-Raleway font-semibold text-sm leading-[21px] mb-3 text-[#456170]">
                  Write a Comment
                </p>
