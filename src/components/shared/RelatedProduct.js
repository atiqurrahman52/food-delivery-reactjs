            ...
            <div className="relative">
                ...
                >
                    ...
                    <Link to='#' className="relative">
                      ...
                      <p class="absolute top-0 w-16 lg:w-20 h-9 lg:h-10 sale font-Raleway font-semibold text-sm lg:text-base text-white flex justify-center items-center">Sale</p>
                    </Link>
