          ...
          <div class="py-4 lg:py-8">
            <div class="grid grid-cols-12 gap-6">
              ...
              <div class="col-span-12 md:col-span-4">
                <div class="bg-[#FAFCFC] lg:h-[681px]">
                  <div class="flex flex-col items-center mb-10">
                    ...
                    <p class="font-Playfair font-bold text-base lg:text-xl leading-6 lg:leading-[30px] text-[#222329] mb-1">
                      MIRZA AL MUSADDEQUE
                    </p>
                    <p class="font-Raleway font-medium text-sm leading-[21px] text-[#A3A3A5]">
                      example@email.com
                    </p>
                  </div>
                  {/* <!-- <ul class="space-y-4 overflow-x-auto border"> --> */}
                  {/* <!-- <ul class="flex flex-row lg:flex-col items-center lg:items-start justify-start lg:space-y-7  space-x-2 overflow-x-auto lg:overflow-x-hidden overflow-y-clip whitespace-nowrap py-3"> --> */}
                  <ul
                    class="flex flex-row md:flex-col items-center lg:items-start justify-start space-y-4 overflow-x-auto md:overflow-x-hidden overflow-y-clip whitespace-nowrap py-3">
                    <li class="px-8">
                    ...
                    <li class="px-8 text-[#004738] activeProfile">
                      <Link to="/payment-options" class="flex items-center gap-1 lg:gap-2.5">
                        {/* <i class="ph-cardholder text-lg"></i> */}
                        <Cardholder size={24} className='text-[#004738]' />
                        <p class="font-Overpass font-semibold text-sm leading-[21px]">Payment Options</p>
                      </Link>
                    </li>
                  </ul>
                </div>
              ...
              <div class="col-span-12 md:col-span-8">
                ...
                <div>
                  <p class="fle gap-10 font-Raleway font-medium text-sm leading-[21px] text-primary/40 mb-4">Account <span>
                      /</span> Payment Options</p>
                </div>
                <div class="mb-8 lg:mb-10">
                  <p
                    class="font-Playfair font-bold text-2xl lg:text-[32px] leading-[29px] lg:leading-[42px] text-primary mb-1">
                    Payment Options</p>
                  <p class="font-Raleway font-medium text-sm lg:text-base leading-[21px] lg:leading-6 text-primary/60">Add
                    or view current payment options</p>
                </div>
    
    
                <div class="border border-[#EBEBEB] p-3 lg:p-6 rounded-xl mb-8">
                  <button type="" class="flex items-center w-max ml-auto space-x-2 pb-6 px-6">
                    <span class="text-success text-xl"><i class="ph-plus text-2xl"></i></span>
                    <p class="font-Raleway font-bold text-sm leading-[21px] text-success">
                      Add New method
                    </p>
                  </button>
    
                  <div
                    class="border border-[#EBEBEB] p-3 lg:p-5 rounded-lg shadow-[0_4px_8px_-2px_rgba(0,0,0,0.1),0_2px_4px_-2px_rgba(0,0,0,0.06)] mb-4">
                    <div class="flex justify-between mb-4">
                      <div class="flex items-center space-x-1 lg:space-x-2">
                        <input class="accent-success" type="radio" id="Home" name="Home" value="Home" />
                        <label for="Home" class="font-Raleway font-semibold text-sm text-[#222329]">Payment with
                          paypal</label>
                      </div>
                      <div>
                        <button type="">
                    ...
                    <div>
                      <p class="font-Raleway font-medium text-base leading-6 text-primary/60">You will be redirected to
                        PayPal website to complete your purchase securely.</p>
                    </div>
                  </div>
                  ...
                  <div
                    ...
                    <div class="flex justify-between mb-4">
                      <div class="flex items-center space-x-1 lg:space-x-2">
                        <input class="accent-success" type="radio" id="Credit" name="Credit" value="Credit" />
                        <label for="Credit" class="font-Raleway font-semibold text-sm text-[#222329]">Credit / Debit
                          Card</label>
                      </div>
                      ...
                      <div>
                        <button type="">
                          <svg width="36" height="24" viewBox="0 0 36 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect x="12.5703" y="3.26953" width="10.21" height="16.68" fill="#F26122" />
                            <path
                    ...
                    <div>
                      <p class="font-Raleway font-medium text-base leading-6 text-primary/60">We support Mastercard, Visa,
                        Amex & American express</p>
                    </div>
                    <button type="" class="flex items-center p-4 space-x-2">
                      <span class="text-success text-xl"><i class="ph-plus text-2xl"></i></span>
                      <p class="font-Raleway font-bold text-sm leading-[21px] text-success">
                        Add Card
                      </p>
                  ...
                  <div
                    ...
                    <div class="flex justify-between mb-4">
                      <div class="flex items-center space-x-1 lg:space-x-2">
                        <input class="accent-success" type="radio" id="Home" name="Home" value="Home" />
                        <label for="Home" class="font-Raleway font-semibold text-sm text-[#222329]">Cash on delivery</label>
                      </div>
                      <div>
                        <button type="">
                          <svg width="36" height="24" viewBox="0 0 36 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div>
                      <p class="font-Raleway font-medium text-base leading-6 text-primary/60">After delivery confirmation
                        you can pay the amount</p>
                    </div>
                  </div>
    
                  <div class="w-max ml-auto pt-4">
                    <button type=""
                      class="border border-[#016A78] font-Raleway font-semibold text-sm leading-[21px] text-[#016A78] w-[94px] h-[36px] rounded-lg mr-2">Edit</button>
                    <button type=""
                      class="bg-[#016A78] font-Overpass font-semibold text-sm leading-[21px] text-white w-[94px] h-[36px] rounded-lg">Edit</button>
                  </div>
                </div>
